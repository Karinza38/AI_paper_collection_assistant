...
class APIHandler:
    ...
    def get_paper_batch(self, session: Session, ids: List[str], fields: str = "paperId,title", **kwargs) -> List[Dict]:
    ...
    @retry(tries=3, delay=2.0)
    def get_author_batch(self, session: Session, ids: List[str], fields: str = "name,hIndex,citationCount", **kwargs) -> List[Dict]:
    ...
    def get_authors(self, all_authors: List[str], batch_size: int = 100, debug_file: Optional[str] = None) -> Dict:
